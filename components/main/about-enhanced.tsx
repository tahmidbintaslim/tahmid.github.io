...
const iconMap: { [key: string]: { svg: string; hex: string } } = {
  siJavascript,
  siTypescript,
  siPhp,
  siRust,
                    ...
                    {category.items.map((item) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {iconSvg ? (
                            <div
                              className={`w-10 h-10 ${category.badgeText} group-hover:scale-110 transition-transform duration-300 icon-fill`}
