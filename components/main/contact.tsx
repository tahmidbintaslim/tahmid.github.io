...
export const Contact = () => {
  ...
  const validationRules = {
    name: [VALIDATION_RULES.required("Name"), VALIDATION_RULES.minLength(2)],
    email: [VALIDATION_RULES.required("Email"), VALIDATION_RULES.email()],
    subject: [
      VALIDATION_RULES.required("Subject"),
      VALIDATION_RULES.minLength(3),
    ],
    message: [
      VALIDATION_RULES.required("Message"),
          ...
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            <div>
              ...
              <input
                ...
                onBlur={handleBlur}
                className={`w-full px-4 py-3 sm:py-3.5 rounded-lg bg-[#1a1a2e] border text-white focus:outline-none focus:ring-2 transition-all text-base min-h-[48px] touch-manipulation ${
                  errors.name
            ...
            <div>
              <label
                ...
                className="block text-gray-300 mb-2 text-sm sm:text-base"
              >
                Message ({formState.message.length}/5000)
              </label>
              <textarea
                id="message"
                name="message"
                ...
                onBlur={handleBlur}
                rows={5}
                className={`w-full px-4 py-3 sm:py-3.5 rounded-lg bg-[#1a1a2e] border text-white focus:outline-none focus:ring-2 transition-all resize-none text-base touch-manipulation ${
                  errors.message
                    ? "border-red-500 focus:border-red-500 focus:ring-red-500/20"
                    : "border-purple-500/30 focus:border-purple-500 focus:ring-purple-500/20"
                }`}
