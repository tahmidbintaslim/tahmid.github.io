...
const feedbackTypes: {
...
}[] = [
  {
    ...
    icon: <IoChatboxOutline className="w-4 h-4" />,
    color: "purple",
  },
  {
    value: "bug",
  ...
  },
  {
    value: "other",
    label: "Other",
    icon: <IoHelpCircleOutline className="w-4 h-4" />,
    color: "gray",
  },
];
  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="hidden md:flex fixed right-6 bottom-36 z-40 h-14 w-14 items-center justify-center rounded-full bg-linear-to-br from-green-500/20 to-emerald-500/20 border border-green-500/30 backdrop-blur-md shadow-lg hover:border-green-400/50 hover:shadow-green-500/20 transition-all duration-300 group"
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 md:top-16.25 h-full md:h-[calc(100vh-65px)] w-full sm:w-100 md:w-105 bg-linear-to-b from-[#0a0a1a]/98 to-[#0d0d20]/98 backdrop-blur-xl border-l border-green-500/20 z-50 flex flex-col shadow-2xl"
            >
              {/* Header */}
              <div className="flex items-center justify-between p-4 border-b border-green-500/20 bg-linear-to-r from-green-500/10 to-transparent">
                ...
                {success ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full py-3 px-4 bg-linear-to-r from-green-500 to-emerald-500 text-white font-semibold rounded-lg hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2"
                    >
                      {loading ? (
                        <>
              ...
              <div className="p-4 border-t border-green-500/20">
                <button
                  onClick={handleClose}
                  className="w-full py-3 flex items-center justify-center gap-2 rounded-xl bg-linear-to-r from-green-500/10 to-emerald-500/10 border border-green-500/30 text-green-300 font-medium hover:bg-green-500/20 transition-all"
                >
